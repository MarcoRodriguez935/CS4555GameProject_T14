...
public class Watchtower : EnemyBase
{
    ...
    */
    ...
    private float beamWidth = 2.5f;
    private float beamHeight = 1.85f;
    ...
    void UpdateBeamTrigger(){
        ...
        Transform anchor = pivot != null ? pivot : (spotLight ? spotLight.transform : eyes);
        
        spotTrigger.transform.SetPositionAndRotation(anchor.position, anchor.rotation);
